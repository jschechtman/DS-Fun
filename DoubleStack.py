...
class DoubleStack:
   ...
   #to beginning of list
    def push1(self, element):
        ...
        #increment it.
        if self.dividing_index == None:
            self.dividing_index = 0
        else:
            self.dividing_index += 1
    ...
    def pop1(self):
        ...
        #Pop first element of list
            ...
            #stack 1 is empty
            if self.dividing_index < 0:
                self.dividing_index = None
            return oldVal
                
    def pop2(self):
        #Empty stack 2: return none
        if self.size == 0 or self.dividing_index == self.size-1:
            return None
    ...
    def peek1():
        if self.dividing_index == None: #If stack 1 is empty
            return None
        else:
            return self.data[self.last1]
        
    def peek2():
        if self.size == 0 or self.dividing_index == self.size-1: #Empty stack 2
            return None
        else: 
